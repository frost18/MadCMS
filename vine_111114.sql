...
REPLACE INTO `lang` (`id`, `key`, `val`, `parent_id`, `module`, `ln`) VALUES
	(1, 'title', 'О компании', 1, 'pages', 'rus'),
	(2, 'text', 'Есть несколько подводных камней, которых следует остерегаться. До версии PHP 5.1.0, instanceof вызывал __autoload() если имя класса не существовало. Вдобавок, если класс не был загружен, происходила фатальная ошибка. Это можно было обойти с помощью динамической ссылки на класс или использования строковой переменной с именем класса:', 1, 'pages', 'rus'),
	(3, 'title', 'About', 1, 'pages', 'eng'),
	(4, 'text', 'There are some pitfalls to watch out for. Prior to version PHP 5.1.0, instanceof caused __autoload () if the class name does not exist. In addition, if the class was not loaded, a fatal error occurs. This can be circumvented by using a dynamic reference to a class or using a string variable with the name of the class:', 1, 'pages', 'eng'),
	(5, 'title', 'saa', 2, 'pages', 'rus'),
	(6, 'text', 'ad', 2, 'pages', 'rus'),
	(7, 'title', 'asd', 2, 'pages', 'eng'),
	(8, 'text', 'asd', 2, 'pages', 'eng'),
	(9, 'keyw', 'qqwerqwe', 1, 'pages', 'rus'),
	(10, 'desc', 'qwerqwer', 1, 'pages', 'rus');
