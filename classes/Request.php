...
class Request
{
    ...
    {
	    $prevPath = isset($_SESSION['prevPath']) ? $_SESSION['prevPath'] : '/';
	    $this->setPrevPath($prevPath);
	...
	public function savePrevPath()
	{
		$_SESSION['prevPath'] = $this->getPathInfo();
	}

	public function setPrevPath($path)
	{
		$this->prevPath = $path;
	}
