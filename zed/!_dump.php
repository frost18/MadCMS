...
class dumper {
	...
	function main(){
		...
		$buttons = "<INPUT TYPE=submit VALUE=Применить><INPUT TYPE=button VALUE=Выход onClick=\"location.href = '!_dump.php?reload'\">";
...
<TR>
<FORM NAME=skb METHOD=POST ACTION=!_dump.php>
